...
class Dataset:
    ...
    def get_buffer(self, index: int) -> buffer: navground.core._navground.Buffer: ...
...
class LocalGridMapStateEstimation(Sensor):
    ...
    resolution: float
    width: int
    footprint: LidarStateEstimation.FootprintType
    def __init__(self, lidars: list[LidarStateEstimation] = ..., external_lidars: list[str] = ..., odometry: OdometryStateEstimation = ..., external_odometry: str = ..., width: int = ..., height: int = ..., resolution: float = ..., include_transformation: bool = ..., footprint: LidarStateEstimation.FootprintType = ..., name: str = ...) -> None: ...
