...
std::vector<core::Disc> sample_discs(
    RandomGenerator &rng, unsigned number, const BoundingBox &bounding_box,
    ng_float_t min_radius, ng_float_t max_radius, ng_float_t margin,
  ...
  std::uniform_real_distribution<ng_float_t> x{
      static_cast<ng_float_t>(bounding_box.getMinX()),
      static_cast<ng_float_t>(bounding_box.getMaxX())};
  std::uniform_real_distribution<ng_float_t> y{
      static_cast<ng_float_t>(bounding_box.getMinY()),
      static_cast<ng_float_t>(bounding_box.getMaxY())};
