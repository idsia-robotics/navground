...
class ExperimentalRun:
    ...
    def stop(self) -> None: ...
    @classmethod
    def target_from_data(self, data: list[float]) -> navground.core._navground.Target: ...
    @property
...
class OdometryStateEstimation(Sensor):
    ...
    def __init__(self, longitudinal_speed_bias: float = ..., longitudinal_speed_std_dev: float = ..., transversal_speed_bias: float = ..., transversal_speed_std_dev: float = ..., angular_speed_bias: float = ..., angular_speed__std_dev: float = ..., name: str = ...) -> None: ...
    @property
...
class Task(TaskRegister, navground.core._navground.HasProperties):
    ...
    @property
    def type(self) -> str: ...
    def log_event(self, list[float]) -> None: ...
