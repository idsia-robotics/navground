...
// template <class T>
// class HasPythonModulations {
//  public:
//   explicit HasPythonModulations() : py_modulations() {
//     py::print("HasPythonModulations::HasPythonModulations");
//   }

//   void add_modulation_py(const py::object obj) {
//     py_modulations.push_back(obj);
//     static_cast<T *>(this)->add_modulation(
//         obj.cast<std::shared_ptr<BehaviorModulation>>());
//   }

//   void remove_modulation_py(py::object &obj) {
//     static_cast<T *>(this)->remove_modulation(
//         obj.cast<std::shared_ptr<BehaviorModulation>>());
//     auto rms =
//         std::remove_if(py_modulations.begin(), py_modulations.end(),
//                        [&obj](py::handle &other) { return other.is(obj); });
//     py_modulations.erase(rms, py_modulations.end());
//   }

//   void clear_modulations_py() {
//     static_cast<T *>(this)->clear_modulations();
//     py_modulations.clear();
//   }

//   void reset_modulations_py() { py_modulations = std::vector<py::object>{}; }
...
class PyBehavior : public Behavior, virtual public PyHasRegister<Behavior> {
 public:
  ...
  // explicit PyBehavior(std::shared_ptr<Kinematics> kinematics = nullptr,
  //                     ng_float_t radius = 0)
  //     : Behavior(kinematics, radius), HasPythonModulations() {}
  ...
  // void add_modulation_py(const py::object obj) {
  //   py_modulations.push_back(obj);
  //   Behavior::add_modulation(obj.cast<std::shared_ptr<BehaviorModulation>>());
  // }

  // void remove_modulation_py(py::object &obj) {
  //   Behavior::remove_modulation(
  //       obj.cast<std::shared_ptr<BehaviorModulation>>());
  //   auto rms =
  //       std::remove_if(py_modulations.begin(), py_modulations.end(),
  //                      [&obj](py::handle &other) { return other.is(obj); });
  ...
  // void clear_modulations_py() {
  //   Behavior::clear_modulations();
  //   py_modulations.clear();
  // }
};

// template <class T>
// struct PySubBehavior : public T, public HasPythonModulations {
//   using Native = Behavior;

//   // std::string get_type() const override { return PyBehavior::get_type(); }

//   explicit PySubBehavior(std::shared_ptr<Kinematics> kinematics = nullptr,
//                          ng_float_t radius = 0)
//       : T(kinematics, radius), HasPythonModulations() {}
// };
...
// template <>
// struct convert<PyBehavior> {
//   static Node encode(const PyBehavior &rhs) {
//     Node node = convert<Behavior>::encode(static_cast<const Behavior
//     &>(rhs)); return node;
//   }
//   static bool decode(const Node &node, PyBehavior &rhs) {
//     std::vector<py::object> modulations;
...
//       }
//     }
//     py::print("Modulations");
//     py::print(modulations.size());
//     Node n = node;
//     n.remove("modulations");
//     if (convert<Behavior>::decode(n, static_cast<Behavior &>(rhs))) {
//       for (auto mod : modulations) {
//         rhs.add_modulation_py(mod);
//       }
//       py::print("ok");
//       return true;
//     }
...
//   if (!obj.is_none()) {
//     py::print(obj);
//     auto &behavior = obj.template cast<PyBehavior &>();
//     printf("behavior %p", &behavior);
//     behavior.reset_modulations_py();
//     convert<PyBehavior>::decode(node, behavior);
//   }
//   return obj;
// }
...
//     }
//   }
//   auto obj = make_type_from_yaml_py<Behavior>(node);
//   if (!obj.is_none()) {
//     Node n = node;
//     n.remove("modulations");
//     PyBehavior &behavior = obj.cast<PyBehavior &>();
//     for (auto &mod : modulations) {
//       behavior.add_modulation_py(mod);
//     }
//     convert<Behavior>::decode(n, behavior);
//   }
//   return obj;
// }
}  // namespace YAML
...
PYBIND11_MODULE(_navground, m) {
  ...
  behavior
      ...
      //      &PyBehavior::clear_modulations_py,
      //      DOC(navground, core, Behavior, clear_modulations))
      // .def("add_modulation", &PyBehavior::add_modulation_py,
      //      py::arg("value"), DOC(navground, core, Behavior, add_modulations))
      // .def("remove_modulation",
      //      &PyBehavior::remove_modulation_py,
      //      py::arg("value"),
