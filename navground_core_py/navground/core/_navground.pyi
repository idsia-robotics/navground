import numpy
import os
from typing import Any, Callable, ClassVar, Iterator, Literal, TypeAlias,overload
...
class Behavior(BehaviorRegister, HasProperties):
    ...
    def cmd_twist_towards_velocity(self, velocity: Vector2Like, time_step: float) -> Twist2: ...
...
class Path:
    ...
    @property
    def curve(self) -> Callable[[float], tuple[Vector2Like, float, float]]: ...
    @property
    def length(self) -> float: ...
    @property
    def loop(self) -> bool: ...
