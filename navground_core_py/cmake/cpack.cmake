...
set(CPACK_PACKAGE_DESCRIPTION "The navground core_py library")
...
elseif(APPLE)
  set(CPACK_PRODUCTBUILD_IDENTIFIER "org.idsia.navground.core_py")
...
if(CPACK_INCLUDE_DEPS)
  if(NOT INCLUDE_PYBIND11)
    set(CPACK_DEBIAN_PACKAGE_DEPENDS "python3-pybind11")
  endif()
else()
