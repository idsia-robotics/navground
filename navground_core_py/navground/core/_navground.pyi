import numpy
import os
from typing import Any, Callable, ClassVar, Iterator, overload, TypeAlias, Literal
...
class Behavior(BehaviorRegister, HasProperties):
    ...
    def cmd_twist_along_path(self, path: Path, speed: float, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_angular_speed(self, angular_speed: float, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_orientation(self, orientation: float, angular_speed: float, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_point(self, point: Vector2, speed: float, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_pose(self, pose: Pose2, speed: float, angular_speed: float, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_stopping(self, time_step: float, frame: Frame) -> Twist2: ...
    def cmd_twist_towards_velocity(self, velocity: Vector2, time_step: float, frame: Frame) -> Twist2: ...
    ...
    def twist_towards_velocity(self, velocity: Vector2Like, frame: Frame) -> Twist2: ...
...
class BehaviorModulationRegister:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def _add_properties(type: str, properties: dict[str, Property]) -> None: ...
    @staticmethod
    def _add_property(type: str, name: str, property: object, default_value: bool | int | float | str | Vector2 | list[bool] | list[int] | list[float] | list[str] | list[Vector2], description: str, deprecated_names: list[str]) -> None: ...
    @staticmethod
    def _register_type(name: str, cls: object) -> None: ...
    @staticmethod
...
class Buffer:
    ...
    shape: tuple
    type: numpy.dtype
    def __init__(self, description: BufferDescription | None = ..., data: Any = ...) -> None: ...
...
class Kinematics(KinematicsRegister, HasProperties):
    ...
    def get_max_angular_speed(self) -> int: ...
    def dof(self) -> int: ...
...
class Path:
    def __init__(self, project: Callable[[Vector2Like, float, float], float], curve: Callable[[float], tuple[Vector2, float, float]], length: float, loop: bool = ...) -> None: ...
...
class SensingState(EnvironmentState):
    ...
    def init_buffer(self, key: str, description: BufferDescription | None = ..., data: Any = ...) -> Buffer | None: ...
...
class Target:
    ...
    @overload
    def satisfied(self, pose: Pose2) -> bool: ...
    @overload
    def satisfied(self, angle: float) -> bool: ...
    @property
    def valid(self) -> bool: ...
