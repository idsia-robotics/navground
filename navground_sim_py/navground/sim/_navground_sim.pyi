...
import os
import pathlib
from typing import Any, Callable, ClassVar, Dict, TypeAlias, List, Literal, Union, Tuple, overload
...
class Agent(NativeAgent):
    ...
    task: Task
    def __init__(self, radius: float = ..., behavior: object = ..., kinematics: object = ..., task: object = ..., state_estimation: object = ..., control_period: float = ..., id: int = ...) -> None: ...
...
class Dataset:
    dtype: numpy.dtype
    item_shape: list[int]
    def __init__(self, data: object = ..., dtype: object = ..., item_shape: list[int] = ...) -> None: ...
    def _pybind11_conduit_v1_(self, *args, **kwargs): ...
    def append(self, values: object, reset: bool = ...) -> None: ...
...
class ExperimentalRun:
    ...
    def add_record(self, key: str, data: object = ..., dtype: object = ..., item_shape: list[int] = ...) -> Dataset: ...
...
class NativeWorld:
    ...
    def add_agent(self, agent: NativeAgent) -> None: ...
...
class Scenario(ScenarioRegister, navground.core._navground.HasProperties):
    class Group:
        def __init__(self) -> None: ...
        def _pybind11_conduit_v1_(self, *args, **kwargs): ...
        def add_to_world(self, world: NativeWorld, seed: int | None = ...) -> None: ...
    ...
    @staticmethod
    def base_schema(reference_register: bool = ...) -> Dict[str, Any]: ...
    def dump(self) -> str: ...
...
class ScenarioRegister:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def _add_properties(type: str, properties: dict[str, navground.core._navground.Property]) -> None: ...
    @staticmethod
    ...
    def _pybind11_conduit_v1_(self, *args, **kwargs): ...
    @staticmethod
    def _register_schema(name: str, schema: Callable) -> None: ...
    @staticmethod
...
class Task(TaskRegister, navground.core._navground.HasProperties):
    ...
    @staticmethod
    def register_schema() -> Dict[str, Any]: ...
    def update(self, world: Agent, agent: World, time: float) -> None: ...
    @property
