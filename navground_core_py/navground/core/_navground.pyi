...
class BicycleKinematics(Kinematics):
    ...
    def __init__(self, max_speed: float = ..., max_backward_speed: float = ..., axis: float = ..., max_steering_angle: float = ..., k: float = ..., use_velocity_norm: bool = ...) -> None: ...
    def _pybind11_conduit_v1_(self, *args: Any, **kwargs: Any) -> Any: ...
    def dof(self) -> int: ...
    def feasible(self, twist: Twist2) -> Twist2: ...
    @property
    def min_steering_radius(self) -> float: ...
    def feasible_steering_angle(self, twist: Twist2) -> float: ...
    def twist_from_steering(self, linear_speed: float, angular_speed: float) -> Twist2: ...
...
class BehaviorGroup(abc.ABC):
    @abc.abstractmethod
    def compute_cmds(self, time_step: float) -> list[Twist2]: ...
    @property
    def members(self) -> list[Behavior]: ...
    @property
    def size(self) -> int: ...

class BehaviorGroupMember(abc.ABC, Behavior):
    @abc.abstractmethod
...
class HasAttributes:
    def get(self, name: str) -> None | bool | int | float | str | Vector2 | list[bool] | list[int] | list[float] | list[str] | list[Vector2]: ...
...
class Target:
    ...
    speed: float | None
    def __init__(self, position: Vector2Like | None = ..., orientation: float | None = ..., speed: float | None = ..., direction: Vector2Like | None = ..., angular_speed: float | None = ..., angular_direction: int | None = ..., path: Path | None = ..., position_tolerance: float = ..., orientation_tolerance: float = ...) -> None: ...
    @staticmethod
...
def convert(value: PropertyField, scalar_type_name: str, is_list: bool) -> PropertyField | None: ...
