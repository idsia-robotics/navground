...
class GroupRecordProbe(Probe):
    ...
    def get_shapes(self, world: World, use_agent_uid_as_key: bool) -> list[int]: ...
...
class Probe:
    def __init__(self) -> None: ...
    def finalize(self, arg0: ExperimentalRun) -> None: ...
    def prepare(self, arg0: ExperimentalRun) -> None: ...
    def update(self, arg0: ExperimentalRun) -> None: ...
...
class Sensor(StateEstimation):
    ...
    def prepare_state(self, arg0: navground.core._navground.SensingState) -> None: ...
