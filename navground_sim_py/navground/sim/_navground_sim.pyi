...
class DiscsStateEstimation(Sensor):
    ...
    def __init__(self, range: float = ..., number: int = ..., max_radius: float = ..., max_speed: float = ..., include_valid: bool = ..., use_nearest_point: bool = ..., max_id: int = ...) -> None: ...
...
class LidarStateEstimation(Sensor):
    ...
    resolution: int
    start_angle: float
    def __init__(self, range: float = ..., start_angle: float = ..., field_of_view: float = ..., resolution: int = ..., position: Vector2 = ..., error_bias: float = ..., error_std_dev: float = ...) -> None: ...
    @property
