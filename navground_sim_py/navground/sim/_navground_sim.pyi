...
from navground.core._navground import Vector2, Vector2Like, PropertyField
import tqdm
...
class BoundingBox:
    ...
    def set_min_x(self, value: float) -> BoundingBox: ...
    def set_min_y(self, value: float) -> BoundingBox: ...
    def set_max_x(self, value: float) -> BoundingBox: ...
    def set_max_y(self, value: float) -> BoundingBox: ...
    @staticmethod
...
class DiscsStateEstimation(Sensor):
    ...
    include_x: bool
    include_y: bool
    def __init__(self, range: float = ..., number: int = ..., max_radius: float = ..., max_speed: float = ..., include_valid: bool = ..., use_nearest_point: bool = ..., max_id: int = ..., include_x: bool = ..., include_y: bool = ..., name: str = ...) -> None: ...
    def _pybind11_conduit_v1_(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_description(self) -> dict[str, navground.core._navground.BufferDescription]: ...
...
class LidarStateEstimation(Sensor):
    ...
    def read_scan(self, state: navground.core._navground.SensingState) -> Scan | None: ...
    @staticmethod
    def read_scan_with_name(state: navground.core._navground.SensingState, name: str) -> Scan | None: ...
    @property
    def angles(self) -> list[float]: ...
    @property
    def angular_increment(self) -> float: ...
...
class NativeWorld(navground.core._navground.HasAttributes):
    ...
    def get_entity(self, uid: int, strict: bool = ...) -> Entity: ...
...
class MarkerStateEstimation(Sensor):
    class ReferenceOrientation:
        __members__: ClassVar[dict[str, MarkerStateEstimation.ReferenceOrientation]] = ...  # read-only
        __entries: ClassVar[dict[str, tuple[MarkerStateEstimation.ReferenceOrientation, str]]] = ...
    ...
    def __init__(self, marker_position: Vector2 = ..., reference_orientation: MarkerStateEstimation.ReferenceOrientation = ..., min_x: float = ..., min_y: float = ..., max_x: float = ..., max_y: float = ..., include_x: bool = ..., include_y: bool = ..., name: str = ...) -> None: ...
    def _pybind11_conduit_v1_(self, *args: Any, **kwargs: Any) -> Any: ...
...
class AgentSampler(Scenario.Group):
    ...
    def reset(self, index: int | None = ..., keep: bool = ...) -> None: ...
...
class Scenario(ScenarioRegister, navground.core._navground.HasProperties):
    ...
    def get_group(self, index: int) -> Scenario.Group | None: ...
    def clear_groups(self) -> None: ...
    def add_group(self, group: Scenario.Group) -> None: ...
    def remove_group(self, group: Scenario.Group) -> None: ...
    def remove_group_at_index(self, index: int) -> None: ...
...
class WaypointsTask(Task):
    ...
    def __init__(self, waypoints: Sequence[Vector2Like] = ..., loop: bool = ..., tolerance: float = ..., random: bool = ..., tolerances: list[float] = ..., orientations: list[float] = ..., angular_tolerance: float = ..., angular_tolerances: list[float] = ..., wait_time: float = ..., wait_times: list[float] = ...) -> None: ...
    def _pybind11_conduit_v1_(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_effective_tolerance(self, index: int) -> float: ...
    def get_effective_angular_tolerance(self, index: int) -> float: ...
    def get_effective_wait_time(self, index: int) -> float: ...
...
class Sampler:
    once: bool
    def sample(self, world: World) -> PropertyField: ...
    def reset(self, index: int | None = ..., keep: bool = ...) -> None: ...
    @staticmethod
    def load(value: str, type_name: str) -> Sampler | None: ...
    def dump(self) -> str: ...
    def done(self) -> bool: ...
    def count(self) -> int: ...
    @property
