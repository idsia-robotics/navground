...
class Action:
    ...
    class State:
        ...
        """
        __members__: typing.ClassVar[dict[str, Action.State]]  # value = {'idle': <State.idle: 0>, 'running': <State.running: 1>, 'failure': <State.failure: 2>, 'success': <State.success: 3>}
    ...
    def done_cb(self) -> typing.Callable[[Action.State], None] | None:
        ...
        """
    @done_cb.setter
    def done_cb(self, arg0: typing.Callable[[Action.State], None] | None) -> None:
        ...
    @property
...
class Behavior(BehaviorRegister, HasProperties):
    ...
    *At regular time intervals*
    ...
    class Heading:
        ...
        current target.
        """
        __members__: typing.ClassVar[dict[str, Behavior.Heading]]  # value = {'idle': <Heading.idle: 0>, 'target_point': <Heading.target_point: 1>, 'target_angle': <Heading.target_angle: 2>, 'target_angular_speed': <Heading.target_angular_speed: 3>, 'velocity': <Heading.velocity: 4>}
        idle: typing.ClassVar[Behavior.Heading]  # value = <Heading.idle: 0>
        target_angle: typing.ClassVar[Behavior.Heading]  # value = <Heading.target_angle: 2>
        target_angular_speed: typing.ClassVar[Behavior.Heading]  # value = <Heading.target_angular_speed: 3>
        target_point: typing.ClassVar[Behavior.Heading]  # value = <Heading.target_point: 1>
        velocity: typing.ClassVar[Behavior.Heading]  # value = <Heading.velocity: 4>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def __getstate__(self) -> tuple:
        ...
    def __init__(self, kinematics: Kinematics | None = None, radius: float = 0) -> None:
        """
        Constructs a new instance.
...
class BufferDescription:
    ...
    """
    def __init__(self, shape: list[int], dtype: typing.Any = 'float', low: float = 2.2250738585072014e-308, high: float = 1.7976931348623157e+308, categorical: bool = False) -> None:
        """
        Constructs a new instance.
...
class CollisionComputation:
    ...
    def get_angles_for_sector(self, from_angle: float, length: float, resolution: int) -> list[float]:
        ...
        """
    def get_contour_for_sector(self, from_angle: float, length: float, resolution: int, max_distance: float, dynamic: bool, speed: float = 0) -> list[float]:
        """
        ...
        """
    def get_free_distance_for_sector(self, from_angle: float, length: float, resolution: int, max_distance: float, dynamic: bool, speed: float = 0) -> list[float]:
        """
        ...
        :return:
            ...
            length].
        """
    def setup(self, pose: Pose2 = ..., margin: float = 0, line_segments: list[LineSegment] = [], static_discs: list[Disc] = [], dynamic_discs: list[Neighbor] = []) -> None:
        """
        ...
        :param dynamic_discs:
            The dynamic discs
        """
    def static_free_distance(self, angle: float, max_distance: float, include_neighbors: bool = True) -> float:
        """
    ...
    *Typical usage of a controller*
    ...
    def follow_velocity(self, velocity: Vector2Like) -> Action:
        ...
        :return:
            The new action.
        """
    def go_to_pose(self, pose: Pose2, position_tolerance: float, orientation_tolerance: float) -> Action:
        """
...
class Frame:
    """
    """
    __members__: typing.ClassVar[dict[str, Frame]]  # value = {'relative': <Frame.relative: 0>, 'absolute': <Frame.absolute: 1>}
...
class HasProperties:
    ...
    "properties".
    """
    def get(self, name: str) -> bool | int | float | str | numpy.ndarray | list[bool] | list[int] | list[float] | list[str] | list[numpy.ndarray]:
        """
        ...
        """
    def set(self, name: str, value: bool | int | float | str | numpy.ndarray | list[bool] | list[int] | list[float] | list[str] | list[numpy.ndarray]) -> None:
        """
...
class KinematicsRegister:
    type_properties: typing.ClassVar[dict]  # value = {'2WDiff': {'wheel_axis': <navground.core._navground.Property object>}, '4WOmni': {'wheel_axis': <navground.core._navground.Property object>}, 'Ahead': {}, 'Omni': {}}
...
class Property:
    ...
    """
    @property
    def default_value(self) -> bool | int | float | str | numpy.ndarray | list[bool] | list[int] | list[float] | list[str] | list[numpy.ndarray]:
        """
...
class SocialMargin:
    ...
    def __init__(self, value: float = 0) -> None:
        ...
        """
    def get(self, type: int | None = None, distance: float | None = None) -> float:
        """
...
class Twist2:
    ...
    def absolute(self, reference: Pose2) -> Twist2:
        ...
        """
    def is_almost_zero(self, epsilon_speed: float = 1e-06, epsilon_angular_speed: float = 1e-06) -> bool:
        """
...
def load_kinematics(value: str) -> typing.Any:
    ...
    """
def load_plugins(plugins: str = '', env: str = '', directory: os.PathLike | None = None) -> None:
    """
    Loads plugins
