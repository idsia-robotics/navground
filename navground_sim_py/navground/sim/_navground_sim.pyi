...
class ExperimentalRun:
    ...
    def get_task_events(self, agent: NativeAgent) -> numpy.typing.NDArray[numpy.float_]: ...
    ...
    @property
    def actuated_commands(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def bounding_box(self) -> BoundingBox: ...
    @property
    def collisions(self) -> numpy.typing.NDArray[numpy.int_]: ...
    @property
    def commands(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def deadlocks(self) -> numpy.typing.NDArray[numpy.int_]: ...
    @property
    def duration(self) -> datetime.timedelta: ...
    @property
    def efficacy(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    ...
    @property
    def neighbors(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def poses(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    ...
    @property
    def safety_violations(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def seed(self) -> int: ...
    @property
    def sensing(self) -> dict[int, dict[str, Dataset]]: ...
    @property
    def targets(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def task_events(self) -> dict[int, numpy.typing.NDArray[numpy.float_]]: ...
    @property
    def terminate_when_all_idle_or_stuck(self) -> bool: ...
    @property
    def time_step(self) -> float: ...
    @property
    def times(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
    def twists(self) -> numpy.typing.NDArray[numpy.float_]: ...
    @property
