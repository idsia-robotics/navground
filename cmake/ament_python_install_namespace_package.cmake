...
#
macro(ament_python_install_namespace_package)
  _ament_cmake_python_register_environment_hook()
  _ament_python_install_namespace_package(${ARGN})
endmacro()
...
function(_ament_python_install_namespace_package package_name)
  ...
  if(NOT EXISTS "${ARG_PACKAGE_DIR}/__init__.py")
    message(FATAL_ERROR "ament_python_install_namespace_package() the Python package "
  ...
  if(NOT ARG_DESTINATION)
    if(NOT PYTHON_INSTALL_DIR)
      message(FATAL_ERROR "ament_python_install_namespace_package() variable "
...
" setup_py_content)
  ...
  install(
    ...
    DESTINATION "${ARG_DESTINATION}/${ARG_NAMESPACE}/${package_name}"
    PATTERN "*.pyc" EXCLUDE
  ...
  if(package_name IN_LIST AMENT_CMAKE_PYTHON_INSTALL_INSTALLED_NAMES)
    message(FATAL_ERROR
      "ament_python_install_namespace_package() a Python module file or package with "
