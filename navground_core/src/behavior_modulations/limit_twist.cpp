...
Twist2 LimitTwistModulation::post(Behavior &behavior,
  ...
  twist.angular_speed = std::clamp(
      twist.angular_speed, -get_max_angular_speed(), get_max_angular_speed());
  return twist;
}

const std::string LimitTwistModulation::type = register_type<
    LimitTwistModulation>(
    "LimitTwist",
    {{"forward", Property::make(&LimitTwistModulation::get_max_forward_speed,
                                &LimitTwistModulation::set_max_forward_speed,
                                std::numeric_limits<ng_float_t>::infinity(),
                                "Maximal forward speed")},
     {"backward", Property::make(&LimitTwistModulation::get_max_backward_speed,
                                 &LimitTwistModulation::set_max_backward_speed,
                                 std::numeric_limits<ng_float_t>::infinity(),
                                 "Maximal backward speed")},
     {"leftward", Property::make(&LimitTwistModulation::get_max_leftward_speed,
                                 &LimitTwistModulation::set_max_leftward_speed,
                                 std::numeric_limits<ng_float_t>::infinity(),
                                 "Maximal leftward speed")},
     {"rightward",
      Property::make(&LimitTwistModulation::get_max_rightward_speed,
                     &LimitTwistModulation::set_max_rightward_speed,
                     std::numeric_limits<ng_float_t>::infinity(),
                     "Maximal rightward speed")},
     {"angular", Property::make(&LimitTwistModulation::get_max_angular_speed,
